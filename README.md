MowItNow
=========
Entretien Xebia : Test technique
...
* java 8
* Maven
* Git - repository: https://github.com/mcm172/mowitnow.git

## Packages :

* enums : regroupe les énumerations
* exeptions : regroupe les exceptions
* main : regroupe les classes metiers
* pojo : classes de données
* util : regroupe les paeser et les constantes

## Création et installation du jar avec Maven

    $ mvn clean install

## Exécution de l'application avec Maven
    $ mvn exec:java
